...
public class Validation {
    ...
    public void textValid(JTextField field,JTextField field1,JTextField field2,JTextField field3,JTextField field4,JTextField field5,JTextField field6,JTextField field7)
    {
        ...
        {
            JOptionPane.showMessageDialog(null,"Eircode must not be more than 7 characters","Error",JOptionPane.ERROR_MESSAGE);
            field5.setText("");
        }
        ...
        if(field7.getText().length()>=10)
        {
            JOptionPane.showMessageDialog(null,"Registration Number must not be more than 9 characters","Error",JOptionPane.ERROR_MESSAGE);
            field7.setText("");
